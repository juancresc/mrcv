...
path_blast=/home/juan/Desktop/juan/bio/mrcv/data/TEs/blast
cd $path_tes
...
do
    ...
    blastn -query allmites.fasta -subject $filename -outfmt "6 qseqid sseqid qstart qend sstart send mismatch gaps pident evalue length qlen slen qcovs"  > ${path_blast}"/mites/$basename.mites.csv"
done
