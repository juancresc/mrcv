...
blastn -perc_identity 80 -task blastn -query data/tes/all.fasta -subject /mnt/disk/iwgsc/by_chr/7D.fasta -outfmt '6 qseqid sseqid qstart qend sstart send score length mismatch gaps gapopen nident pident qlen slen qcovs' -evalue 10e-3 -qcov_hsp_perc 80 > blast7D.csv
=======
